package cn.wittyneko.autolayout.helper.base;

import cn.wittyneko.autolayout.helper.AutoLayoutHelper;
...
public class SampleModel implements BaseModel{
    ...
    public SampleModel getDefaultDesign(){
        designWidth = AutoLayoutHelper.getDisplay().getDisplayWidth();
        designHeight = AutoLayoutHelper.getDisplay().getDisplayHeight();
        return this;
    }
}
